...
Save the residuals you obtain in the first stage regression from Question 5. Estimate equation (1) using OLS, this time adding the residuals as an additional control variable. What do you observe about the estimated β1 coefficient? Is the coefficient on the first-stage residuals statistically significant, and what might this mean? Note that this procedure is known as the “control function” approach to instrumental variables regression. Explain why it might obtain consistent estimates of causal effects.
